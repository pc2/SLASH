...
pushd ${VPP_DIR}
    ./scripts/v80++ --design-name $DESIGN_NAME --cfg $HOME_DIR/config.cfg --kernels $HLS_DIR/$HLS_BUILD_DIR_DMA_IN/sol1 $HLS_DIR/$HLS_BUILD_DIR_PASSTHROUGH/sol1 $HLS_DIR/$HLS_BUILD_DIR_DMA_OUT/sol1
